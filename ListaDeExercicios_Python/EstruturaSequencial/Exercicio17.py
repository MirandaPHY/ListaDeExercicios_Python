...
metro = float(input("Tamanho em metros quadrados a ser pintada: "))

litros = metro * 6
latas = litros / 18

if litros >= 18 and litros >= 3.6:
      print("misturar latas e galões, de forma que o desperdício de tinta seja menor")
else:
